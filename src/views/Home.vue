            ...
            <div class="col-12 col-md-6">
              <div class="personal_text mt-3">
                ...
                <ul class="list basic_info">
                  <li><a href="#"><i class="fa fa-phone"></i> (92) 999537-5239</a></li>
                  <li><a href="#"><i class="fa fa-envelope"></i> nunes.eduardo1993@gmail.com</a></li>
                  <li><a href="#"><i class="fa fa-home"></i> Manaus-AM</a></li>
                </ul>
